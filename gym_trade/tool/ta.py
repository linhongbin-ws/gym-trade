...
# def chg(df: pd.DataFrame, key:str):
#     """ perentage of change """
#     _df = df.copy()
#     assert key in df.columns

#     feature_name = 'chg_'+key
#     _df[feature_name] =_df[key].pct_change()
#     return _df, [feature_name]

# def rsi(df: pd.DataFrame, key:str, length:int):
#     _df = df.copy()
#     assert length>0 and key in df.columns
#     feature_name = 'rsi_'+key+'_'+str(length)
#     _df[feature_name] = ta.rsi(_df[key], length=length)
#     return _df, [feature_name]
